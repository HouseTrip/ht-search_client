module Ht::SearchClient
  #
  # GET /point/:lat,:long/stays?from=:from&to=:to&radius=:radius
  #
  ...
  #
  # Response:
  #   - An array of stays data, distance data and pagination details
  #   {
  #     'total'    => 120,
  #     'per_page' => 32,
  #     'page'     => 1,
  ...
  #     - Ht::SearchClient::PointStaySearch.new({})
  #   then call #perform on the newly created object
  #   The #perform method is defined in the Remote class
  #
  class PointStaySearch < PointSearch
    include StaySearch

    private

    def endpoint
      "point/#{latitude},#{longitude}/stays"
    end
  end
end
